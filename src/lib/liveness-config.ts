...
export const CONFIG = {
  ...
  TTS_ENABLED: true,
  TTS_RATE: 1.0, // legacy fallback; per-language rates below take precedence
  TTS_RATE_EN: 1.0,
  TTS_RATE_BN: 1.0,
  TTS_VOLUME: 1.0,
  TTS_GAP_MS: 350,
  ...
  // Prioritize clearer/natural engines first.
  TTS_QUALITY_NAME_HINTS: ["neural", "enhanced", "premium", "google", "natural", "wavenet"] as const,
